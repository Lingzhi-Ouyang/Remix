----------------------------- MODULE MSPEC_2 -----------------------------
(* This is the mixed-grained specification for ZooKeeper 3.9.1. *)
(* Note: In order to explore the potential consequences of the non-atomicity
    of the logic when a follower processes NEWLEADER. *)
